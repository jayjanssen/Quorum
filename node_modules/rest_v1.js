  ...
  var get_lease_response = function( req, lease, callback ) {    
    ...
    lease.fetch( function( obj ) {
      ...
      if( type === 'application/xml') {
        ...
        output += '<?xml-stylesheet type="text/xsl" href="/v1/lease.xsl"?>\n' ;
        output += lease.toXML();
...
<h2>Lease: <xsl:value-of select=\"key\"/></h2>\n\
  ...
  // handle xsl requests
  var get_xsl = function( req, response ) {
    if( req.pathname === '/v1/lease.xsl' ) {
      response( 200, { 'Content-Type': 'text/xml'}, lease_xsl );
    }
  }
