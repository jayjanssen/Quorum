...
var RestV1 = function() {
  ...
  var get_response = function( lease, callback ) {
    log.debug( "Attempting get_response on " + lease.key() );
    async.parallel({
      'content' : function( cb ) {
        lease.get_client_object( function( obj ) { cb( null, obj ); });
      },
      'X-Quorum-Client-ID' : function( cb ) {
        lease.get_owner( function( value ) { cb( null, value ); });
      },
      'X-Quorum-Lease-Length' : function( cb ) {
        lease.get_ttl( function( value ) { cb( null, value ); });
      },
      'X-Quorum-Lease-Acquired' : function( cb ) {
        lease.get_acquired( function( value ) { cb( null, value ); });
      },
      'X-Quorum-Lease-Expires' : function( cb ) {
        lease.get_expires( function( value ) { cb( null, value ); });
      },          
      'X-Quorum-Lease-Renewed' : function( cb ) {
        lease.get_renewed( function( value ) { cb( null, value ); });
      },      
      'X-Quorum-Lease-Renewals' : function( cb ) {
        lease.get_renewals( function( value ) { cb( null, value ); });
      },      
      'X-Quorum-Lease-Version' : function( cb ) {
        lease.get_version( function( value ) { cb( null, value ); });
      }      
      ...
      // Separate the content from the other headers
      var content = headers.content;
      delete headers.content;      
      
      log.trace( "Headers: " + util.inspect( headers ));
      log.trace( "Content: " + util.inspect( content ));
  ...
  var get = function( req, response ) {
    ...
    lease.is_valid( function( bool ) {
      ...
      get_response( lease, function( headers, content ) {
        if( content === '' ) { //???
