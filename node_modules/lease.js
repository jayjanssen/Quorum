...
var QuorumLease = function( key ) {
  ...
  that.toString = function( obj ) {
    ...
    for( index in obj.history ) {
      if( obj.history.hasOwnProperty( index )) {          
        ...
        result += "    " + old_lease.owner + " started " + format_unixtime( old_lease.acquired );
  ...
  that.toHTML = function() {
    ...
    var result = "<table>"
    result += "<tr><td>Lease</td><td>" + lease_key + "</td></tr>";
    ...
    result += "<tr><td>Owner</td><td>" + obj.owner_name + " (" + obj.owner + ")</td></tr>\n";
    result += "<tr><td>TTL</td><td>" + obj.ttl + "</td></tr>\n";
    
    result += "<tr><td>Acquired</td><td>" + format_unixtime( obj.acquired ) + "</td></tr>\n";
    
    result += "<tr><td>Renewed</td><td>" + format_unixtime( obj.renewed ) + "</td></tr>\n";
    
    if( obj.is_valid ) {
      result += "<tr><td>Expires</td><td>" + format_unixtime( obj.expires ) + "</td></tr>\n";
              
      var diff = get_unixtime() - obj.acquired;
      result += "<tr><td>Time Held</td><td>" +  format_seconds( diff ) + "</td></tr>\n";
    } else {      
      var diff;
      if( obj.released ) {
        result += "<tr><td>Released</td><td>" + format_unixtime( obj.released ) + "</td></tr>\n";        
        diff = obj.released - obj.acquired;
      } else {
        result += "<tr><td>Expired</td><td>" + format_unixtime( obj.expires ) + "</td></tr>\n";
        diff = obj.expires - obj.acquired;
      }
      result += "<tr><td>Time Held</td><td>" +  format_seconds( diff ) + "</td></tr>\n";

    }
    result += "<tr><td>Renewals</td><td>" + obj.renewals + "</td></tr>\n";
    result += "<tr><td>Version</td><td>" + obj.version + "</td></tr>\n";
    
    result += "<tr><td>Client Object</td><td>" + obj.client_object + "</td></tr>\n";
  
    result += "<tr><td>History</td><td>";
